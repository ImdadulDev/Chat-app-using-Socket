...
import com.cbc.networkutils.JSONMAPPost
...
class OTPbottomSheetDialog : BottomSheetDialogFragment() {
    ...
    var devicetoken = "test" // TODO STATIC
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        devicetoken = context?.let { AppSharePref(it).getDeviceId() }!!
        ...
        BTN_VERIFY.setOnClickListener {
            ...
            param.put("otp", EDX_OTP.text.toString().trim())
            param.put("phone", param2!!)
            param.put("deviceToken", devicetoken!!)
            param.put("countryCode", JSON.optString("countryCode"))
        ...
        TXT_RESENDOTP.setOnClickListener {
            ResendOtp(JSON.optString("countryCode"), param2)
        }
    }

    private fun ResendOtp(countrycode: String, param2: String?) {
        val param = HashMap<String, Any>()
        param.put("phone", param2!!)
        param.put("countryCode", countrycode)
        JSONMAPPost(URLs.RESENDOTP, param, null, object : Responselistener {
            override fun Start() {
                loader.show()
            }
            ...
            override fun OnSucess(Responseobject: String?) {
                ...
                EDX_OTP.setText(resp.optString("otp"))

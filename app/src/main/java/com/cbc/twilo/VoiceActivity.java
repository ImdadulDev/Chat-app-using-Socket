...
//    private static final String TWILIO_ACCESS_TOKEN_SERVER_URL = "TWILIO_ACCESS_TOKEN_SERVER_URL";
    private static final String TWILIO_ACCESS_TOKEN_SERVER_URL = "http://nodeserver.brainiuminfotech.com:3010/accessToken";
    private static final int MIC_PERMISSION_REQUEST_CODE = 1;
    private static String identity = "bob1";
    ...
    private static AlertDialog createCallDialog(final DialogInterface.OnClickListener callClickListener,
        ...
        View dialogView = li.inflate(R.layout.dialog_call_voice, null);
...
//        callActionFab.show();
    ...
    public void CALL_PHONE(String mob) {
        params.put("to", mob);
        params.put("to", mob);
        ConnectOptions connectOptions = new ConnectOptions.Builder(accessToken)
                .params(params)
